...
import com.example.videocallingstreamsdkmvi.connection.ConnectScreen
...
import com.example.videocallingstreamsdkmvi.video.CallState
import com.example.videocallingstreamsdkmvi.video.VideoCallViewModel
import com.example.videocallingstreamsdkmvi.video.VideoCallingScreen
                ...
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    ...
                    NavHost(
                        ...
                        composable<VideoCallRoute> {
                            ...
                            VideoTheme {
                                VideoCallingScreen(state = state, onAction = viewModel::onAction)
                            }
                        }
                    }
                }
